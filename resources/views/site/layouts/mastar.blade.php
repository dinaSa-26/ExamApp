...
<body class="rtl active-pageloader corporate logistics header-sticky hide-on-scroll header-menu-with-icons header-menu-border-bottom header-topbar topbar-background dark-color footer-widgets footer-background dark-color submenu-show-arrow-right menu-is-capitalized submenu-is-capitalized logo-text-is-capitalized page-index">
                        ...
                        <div class="blog-list style-2 columns is-variable is-4 is-multiline">
                                ...
                                <article class="blog-post">
                                    <figure class="post-image">
                                        <a href="./pages/about.html">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/blog/1.png"> </a>
                                    </figure>
                            ...
                            <div class="column is-4" data-aos="fade">
                                <article class="blog-post">
                                    <figure class="post-image">
                                        <a href="./pages/about.html">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/blog/2.png"> </a>
                                    </figure>
                                    <div class="entry-header">
                                        <h2 class="entry-title">
                            ...
                            <div class="column is-4" data-aos="fade">
                                <article class="blog-post">
                                    <figure class="post-image">
                                        <a href="./pages/about.html">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/blog/3.png"> </a>
                                    </figure>
                                    <div class="entry-header">
                                        <h2 class="entry-title">
                    ...
                    <div class="container">
                        ...
                        <div class="columns is-variable is-4 is-multiline boxes-style-2">
                            <div class="column is-4" data-aos="fade">
                                <div class="box-item">
                                    <a href="./pages/services.html">
                                        <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/icons/4.png"> </a>
                                    <h3>
                            ...
                            <div class="column is-4" data-aos="fade">
                                <div class="box-item">
                                    <a href="./pages/services.html">
                                        <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/icons/3.png"> </a>
                                    <h3>
                            ...
                            <div class="column is-4" data-aos="fade">
                                <div class="box-item">
                                    <a href="./pages/services.html">
                                        <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/icons/1.png"> </a>
                                    <h3>
                            ...
                            <div class="column is-4" data-aos="fade">
                                <div class="box-item">
                                    <a href="./pages/services.html">
                                        <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/icons/2.png"> </a>
                                    <h3>
                            ...
                            <div class="column is-6-desktop is-12-tablet has-text-centered" data-aos="fade-up">
                                <div class="works-latest">
                                    <div class="works-latest-item">
                                        <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/global/introduction.png">
                            ...
                            <div class="column is-6-desktop is-12-tablet" data-aos="fade">
                                ...
                                <div class="level">
                                    ...
                                    <div class="level-right">
                                        <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/global/mark.png"> </div>
                                </div>
                            </div>
                        </div>
                        <br> </div>
                          ...
                          <i class="ion-ios-arrow-round-forward"></i>
                                ...
                                <article class="blog-post">
                                    <figure class="post-image">
                                        <a href="./blog/single.html">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/blog/4.png"> </a>
                                    </figure>
                                    <div class="entry-header">
                                        <div class="post-meta">
                                            <ul>
                            ...
                            <div class="column is-4" data-aos="fade">
                                <article class="blog-post">
                                    <figure class="post-image">
                                        <a href="./blog/single.html">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/blog/5.png"> </a>
                                    </figure>
                                    <div class="entry-header">
                                        <div class="post-meta">
                                            <ul>
                    ...
                    <div class="container">
                        ...
                        <div class="testimonials  owl-carousel dots carousel-items-3 columns-style-1 ">
                            <div class="testimonials-item">
                                ...
                                <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/testimonials/1.png">
                                <h3>محمد أحمد
                                    <br>
                            ...
                            <div class="testimonials-item">
                                <p>هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم، غير منسق، أو حتى غير مفهوم. لأنه مازال نصاً بديلاً ومؤقتاً.</p>
                                <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/testimonials/2.png">
                                <h3>olivia allison
                                    <br>
                                    <span>CEO & stylist</span>
                                </h3>
                            ...
                            <div class="testimonials-item">
                                <p>هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم، غير منسق، أو حتى غير مفهوم. لأنه مازال نصاً بديلاً ومؤقتاً.</p>
                                <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/testimonials/3.png">
                                <h3>olivia allison
                                    <br>
                                    <span>CEO & stylist</span>
                                </h3>
                      ...
                      <span class="icon">
                        <i class="ion-md-notifications"></i>
                            ...
                            <div class="column is-6-desktop is-12-tablet" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <br>
                                <br>
                                <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/global/man.png"> </div>
                        </div>
                    </div>
                </section>
            </div>
                                ...
                                <nav class="clients-list level  owl-carousel no-dots carousel-items-5">
                                    <div class="client-item has-text-centered level-item">
                                        <a href="#" target="_blank">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/clients/7.png"> </a>
                                    </div>
                                    <div class="client-item has-text-centered level-item">
                                        <a href="#" target="_blank">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/clients/8.png"> </a>
                                    </div>
                                    <div class="client-item has-text-centered level-item">
                                        <a href="#" target="_blank">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/clients/9.png"> </a>
                                    </div>
                                    <div class="client-item has-text-centered level-item">
                                        <a href="#" target="_blank">
                                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/clients/7.png"> </a>
                ...
                <div class="image-hover effect-5">
                    <div class="columns is-variable is-multiline is-2">
                        <div class="column is-6">
                            <figure>
                                <img alt="Joo - Niche Multi-Purpose HTML Template" src="site/assets/images/portfolio//demos/creative-1.png">
                                <figcaption>
                                    <h5>إبداعى 01</h5>
